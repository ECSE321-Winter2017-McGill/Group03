	...
	private void initComponents() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup().addComponent(formTitle).addComponent(horizontalLineTop)
				...
				.addGroup(layout.createSequentialGroup()
						.addGroup(layout.createParallelGroup().addComponent(semesterLabel, 200, 250, 500)
								.addComponent(nameLabel).addComponent(codeLabel).addComponent(creditLabel)
								.addComponent(maxStudentLabel).addComponent(instructorLabel).addComponent(numLabLabel)
								.addComponent(numTutorialLabel).addComponent(labHourLabel)
								.addComponent(tutorialHourLabel).addComponent(numGraderNeededLabel)
								.addComponent(totalGraderHourLabel).addComponent(backButton))
						.addGroup(layout.createParallelGroup().addComponent(semesterToggleList)
								.addComponent(nameTextField).addComponent(codeTextField).addComponent(creditTextField)
								.addComponent(maxStudentTextField, 200, 250, 500).addComponent(instructorTextField)
								.addComponent(numLabTextField).addComponent(numTutorialTextField)
								.addComponent(labHourTextField).addComponent(tutorialHourTextField)
								.addComponent(numGraderNeededTextField).addComponent(totalGraderHourTextField))));
		...
		layout.setVerticalGroup(layout.createSequentialGroup().addComponent(formTitle)
				...
				.addGroup(layout.createParallelGroup().addComponent(semesterLabel).addComponent(semesterToggleList))
				.addGroup(layout.createParallelGroup().addComponent(nameLabel).addComponent(nameTextField, 23, 23, 23))
				.addGroup(layout.createParallelGroup().addComponent(codeLabel).addComponent(codeTextField, 23, 23, 23))
				.addGroup(layout.createParallelGroup().addComponent(creditLabel).addComponent(creditTextField, 23, 23,
						23))
				.addGroup(layout.createParallelGroup().addComponent(maxStudentLabel).addComponent(maxStudentTextField,
						23, 23, 23))
				.addGroup(layout.createParallelGroup().addComponent(instructorLabel).addComponent(instructorTextField,
						23, 23, 23))
				.addGroup(layout.createParallelGroup().addComponent(horizontalLineMiddle))
				.addGroup(layout.createParallelGroup().addComponent(numLabLabel).addComponent(numLabTextField, 23, 23,
						23))
				.addGroup(layout.createParallelGroup().addComponent(numTutorialLabel).addComponent(numTutorialTextField,
						23, 23, 23))
				.addGroup(layout.createParallelGroup().addComponent(labHourLabel).addComponent(labHourTextField, 23, 23,
						23))
				.addGroup(layout.createParallelGroup().addComponent(tutorialHourLabel)
						.addComponent(tutorialHourTextField, 23, 23, 23))
				.addGroup(layout.createParallelGroup().addComponent(numGraderNeededLabel)
						.addComponent(numGraderNeededTextField, 23, 23, 23))
				.addGroup(layout.createParallelGroup().addComponent(totalGraderHourLabel)
