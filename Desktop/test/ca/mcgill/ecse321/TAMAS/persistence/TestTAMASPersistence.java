...
public class TestTAMASPersistence {
	...
	public void setUp() throws Exception {
		...
		// create course
		Course c1 = new Course("Winter2017", "ECSE", "321", 1, 1, 300, 3, 5, 2, 2, 3, 10, 10.0, i1, ms);
		Course c2 = new Course("Fall2018", "COMP", "251", 2, 2, 200, 4, 6, 3, 1, 2, 10, 15.0, i2, ms);
		...
		new Application(1, jp1, ap1);
		new Application(1, jp2, ap2);
