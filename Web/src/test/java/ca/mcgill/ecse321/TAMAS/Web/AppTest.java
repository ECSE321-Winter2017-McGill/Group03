...
// @BeforeClass
// public static void setUpBeforeClass() throws Exception {
// ms=PersistenceXStream.initializeModelManager("output"+File.separator+"data2.xml");
// }
//
// @AfterClass
// public static void tearDownAfterClass() throws Exception {
...
// String evaluation = "He/She is very good";
// TController tc = new TController(ms);
// Applicant aApplicant = new Applicant(111, "abc", "", true, "", "","", "", "",
// "", 10, ms);
// ms.addApplicant(aApplicant);
// assertEquals(1, ms.getApplicants().size());
//
...
// assertEquals(evaluation, ms1.getApplicants().get(0).getEvaluation());
//
// ManagementSystem ms2 = (ManagementSystem)
...
// }
//
// private void checkResultJobPositing(String jobTitle, Date deadline, String
// exp, double hourRate, ManagementSystem ms2){
// assertEquals(0, ms2.getApplicants().size());
// assertEquals(1, ms2.getJobPostings().size());
// assertEquals(1, ms2.getCourses().size());
// assertEquals(jobTitle, ms2.getJobPosting(0).getJobTitle());
// assertEquals(deadline.toString(),
// ms2.getJobPosting(0).getSubmissionDeadline().toString());
// assertEquals(exp, ms2.getJobPosting(0).getPerferredExperience());
// assertEquals(String.valueOf(hourRate),
// String.valueOf(ms2.getJobPosting(0).getHourRate()));
// }
//
// @Test
// public void testCreateJobPostingNullDate() {
...
//
// ManagementSystem ms1 = ms;
// checkResultApplication(name, id, major, isUndergrad, year, exp, firstChoice,
// secondChoice, thirdChoice, totalAppointmentHour, ms1);
//
//
// ManagementSystem ms2 = (ManagementSystem)
// PersistenceXStream.loadFromXMLwithXStream();
// checkResultApplication(name, id, major, isUndergrad, year, exp, firstChoice,
// secondChoice, thirdChoice, totalAppointmentHour, ms);
//
// ms2.delete();
// }
//
// private void checkResultApplication( String name, int id, String
// major,boolean isUndergrad,String year,
// String exp, String firstChoice, String secondChoice, String thirdChoice, int
// totalAppointmentHour, ManagementSystem ms2){
//
// assertEquals(1, ms2.getApplicants().size());
// assertEquals(1, ms2.getJobPostings().size());
// assertEquals(1, ms2.getCourses().size());
...
// assertEquals(secondChoice, ms2.getApplicant(0).getSecondChoice());
// assertEquals(thirdChoice, ms2.getApplicant(0).getThirdChoice());
// assertEquals(totalAppointmentHour,
// ms2.getApplicant(0).getTotalAppointmentHours());
// assertEquals("SELECTED",
// ms2.getApplicant(0).getApplication(0).getStatus().toString());
// }
//
// @Test
// public void testCreateApplicationNullName() {
...
// int totalAppointmentHour = 10;
//
// Applicant ap = new Applicant(id, name, exp, isUndergrad, major, year,
...
// }
//
// private void checkResultRegisterApplicant( String name, ManagementSystem ms2,
// int index){
//
// assertEquals(3, ms2.getApplicants().size());
// assertEquals(0, ms2.getJobPostings().size());
...
// assertEquals(0, ms.getApplicants().size());
//
// Applicant ap1 = new Applicant(111, "a", "", true, "", "","", "", "", "", 10,
// ms);
// Applicant ap2 = new Applicant(111, "b", "", true, "", "","", "", "", "", 10,
// ms);
// Applicant ap3 = new Applicant(111, "c", "", true, "", "","", "", "", "", 10,
// ms);
//
// assertEquals(3, ms.getApplicants().size());
//
...
// }
//
// private void checkResultRegisterInstructor( String name, ManagementSystem
// ms2, int index){
//
...
// }
//
// private void checkResultCourse(String semester, String courseName, String
// courseCode, int credit,
// int maxStudent, String instructorName,int numGraderNeeded, int numLab, int
// numTut, int labHour,
...
// }
// error = error.trim();
// assertEquals("Please specify the number of credits in the correct format!",
// error);
//
// assertEquals(0, ms.getCourses().size());
// }
...
// }
// error = error.trim();
// assertEquals("Please specify the maximum number of students in the correct
// format!", error);
//
// assertEquals(0, ms.getCourses().size());
// }
...
//
// String error = null;
// String realError = ("Please specify the numebr of lab sessions in the correct
// format! "
// + "Please specify the number of tutorials in the correct format!").trim();
//
// String semester = "Winter3000";
...
//
// String error = null;
// String realError = ("Please specify the number of Grader needed in the
// correct format! ").trim();
//
// String semester = "Winter3000";
// String courseName = "ECSE";
...
// assertEquals(0, ms.getApplicants().size());
//
// Applicant ap = new Applicant(111, "abc", "", true, "", "","", "", "", "", 10,
// ms);
// ms.addApplicant(ap);
// assertEquals(1, ms.getApplicants().size());
//
...
// }
//
// private void checkResultAcceptApplication(Application app, ManagementSystem
// ms2){
//
// assertEquals(1, ms2.getApplicants().size());
// assertEquals(1, ms2.getJobPostings().size());
...
// }
//
// private void checkResultRejectApplication(Application app, ManagementSystem
// ms2){
//
// assertEquals(1, ms2.getJobPostings().size());
// assertEquals(1, ms2.getCourses().size());
