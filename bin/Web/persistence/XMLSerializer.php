...
class XMLSerializer {
	 ...
	 *
	 * @param mixed $obj
	 *        	=> can be an objectm, an array or string. may contain unlimited number of subobjects and subarrays
	 * @param string $wrapper
	 *        	=> main wrapper for the xml
	 * @param
	 *        	array (key=>value) $replacements => an array with variable and object name replacements
	 * @param boolean $add_header
	 *        	=> whether to add header to the xml string
	 * @param
	 *        	array (key=>value) $header_params => array with additional xml tag params
	 * @param string $node_name
	 *        	=> tag name in case of numeric array key
	 */
